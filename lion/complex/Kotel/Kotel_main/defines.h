...
#define ALARM_VOLT_ACC_MIN 2.00     //минимальное  напряжение аккумулятора //изменить на реальную цифру
#define ALARM_VOLT_ACC_MAX 4.00     //максимальное напряжение аккумулятора //изменить на реальную цифру
